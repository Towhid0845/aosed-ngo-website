    ...
    <div class="main">
      ...
      <section id="what_we_do">
        <div class="container">
          <div class="row wwd">
            ...
            <div class="about_top_boxed bg_five">
              <div class="about_top_boxed_icon">
        ...
        <div class="container">
                  ...
                  <div class="event_boxed_bottom_wrapper">
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="event_bottom_boxed">
                          <div class="event_bottom_icon">
                            <img src="./images/icon/map.png" alt="icon">
                          </div>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="event_bottom_boxed">
                          <div class="event_bottom_icon">
                            <img src="./images/icon/clock.png" alt="icon">
                          </div>
                          <div class="event_bottom_content">
                            <h5>Starts at:</h5>
                            <p>10 am</p>
          ...
          <div class="row mt-4">
            <div class="col-12 text-center">
              <a href="event-list.php" class="btn btn_theme btn_md">View All Events</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="notice">
            <div class="row">
              <div class="col-lg-4 mb-3">
                <ul class="d-flex align-items-center position-relative list-unstyled">
                  <li class="date text-center px-2">
                    17 Nov 2023 <span class="d-block"></span>
                  </li>
                  <li class="info"><a href="#" target="_blank">Lorem ipsum dolor sit amet consectetur</a>
                  </li>
                  <li class="pdf">
                    <a href="#" target="_blank"><img src="./images/pdf.png" alt=""></a>
                  </li>
                </ul>
              </div>
              <div class="col-lg-4 mb-3">
      ...
      <section id="news" class="section_after">
        <div class="container">
          ...
          <div class="row mt-5">
            <div class="col-12 text-center">
              <a href="story-list.php" class="btn btn_theme btn_md" style="z-index: 9;">View All Stories</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="owl-carousel owl-theme">
                ...
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner2.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner3.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner4.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner5.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner6.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner7.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner8.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner9.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner10.webp" alt="img"></a>
                </div>
                <div class="partner_logo">
                  <a href="#!"><img src="./images/partner11.webp" alt="img"></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="subscribe_text">
                  <p>Newsletter</p>
                  <h3>To get weekly & monthly news, Subscribe to our newsletter.
                  </h3>
                </div>
              </div>
              <div class="col-lg-6">
