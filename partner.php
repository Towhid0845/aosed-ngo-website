    ...
    <div class="container">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Give2Asia- USA</td>
                    <td><a href="https://give2asia.org/" target="_blank">https://give2asia.org/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/giz.webp" alt="not found"></td>
                    <td>Deutsche Gesellschaft für Internationale Zusammenarbeit – GIZ</td>
                    <td><a href="https://www.giz.de/en/html/index.html" target="_blank">https://www.giz.de/en/html/index.html</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/wsscc.jpg" alt="not found"></td>
                    <td>Water Supply & Sanitation Collaborative Council WSSCC</td>
                    <td><a href="	https://www.wsscc.org/" target="_blank"> https://www.wsscc.org/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/apwf.jpg" alt="not found"></td>
                    <td>Asia Pacific Water Forum-APWF</td>
                    <td><a href="http://www.apwf.org/" target="_blank">http://www.apwf.org/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/bothends.svg" alt="not found"></td>
                    <td>BothENDS</td>
                    <td><a href="https://www.bothends.org/en/" target="_blank">https://www.bothends.org/en/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/brot.svg" alt="not found"></td>
                    <td>Bread for the Word</td>
                    <td><a href="https://www.brot-fuer-die-welt.de/en/" target="_blank">https://www.brot-fuer-die-welt.de/en/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/can.svg" alt="not found"></td>
                    <td>Climate Action Network</td>
                    <td><a href="http://www.climatenetwork.org/" target="_blank">http://www.climatenetwork.org/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/cansa.png" alt="not found"></td>
                    <td>Climate Action Network South Asia</td>
                    <td><a href="https://www.cansouthasia.net/" target="_blank">https://www.cansouthasia.net/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/ewp.svg" alt="not found"></td>
                    <td>End Water Poverty</td>
                    <td><a href="https://www.endwaterpoverty.org/" target="_blank">https://www.endwaterpoverty.org/</a></td>
                  </tr>
                  <tr>
                    <td><img src="./images/fan.jpg" alt="not found"></td>
                    <td>Freshwater Action Network</td>
                    <td><a href="	http://www.freshwateraction.net" target="_blank"> http://www.freshwateraction.net</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <!-- <div class="content-main">
        <div class="row">
          <div class="col-lg-12">
            <div class="image">
              <img src="./images/sm3.jpg" alt="content-img">
            </div>
            <div class="text background">
              <p>
                The Southwest Coastal Region of Bangladesh is a part of the Ganges flood plain, geographical location has given it a brackish water regime. It contains a highly productive mangrove ecosystem Sundarbans, unique type of biodiversity and most of the areas are tidal wetlands. Human civilization and culture of the region has developed throughout the centuries by optimum utilization of natural resources and addressing natural disasters.
              </p>

              <p>In this context, a group of young, energetic and socially committed enthusiasts have formed ‘AOSED-An Organization for Socio-Economic Development’ in 1999 </p>

              <p>Since the journey, AOSED addressing Water Justice, Food security and agriculture, environment conservation and climate change, health & hygiene, Disaster Risk Reduction and Emergency response issues through implementing.</p>
            ...
            <ul>
              ...
              <li>Uphold peoples’ rights to common property resources.</li>
              <li>Ensure peoples’ access to safe water and sanitation.</li>
              <li>Ensure peoples’ access to safe water and sanitation.</li>
              <li>Upholding human rights especially children’s and woman’s rights, and democratic governance
            ...
            <h6>Here are some of the company's core values:</h6>
            <table>
              <tbody>
                <tr>
                  <th>Quality&nbsp;</th>
            ...
            &nbsp;
            &nbsp;
            <p class="content-border-dots-style">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam, consequuntur!
            </p>
